                    ...
                    <div className="row mb-5">
                        <div className="col-12">
                            <div className="section__title section__title--page text-center">
                                { global.lan ===false ? <p>CTHULHU uses a unique algorithm to generate profits in BUSD and other tokens. In addition, we are creating our own ecosystem, which will include the functions of AMM, P2E, mini-games and much more.</p>
                                : <p>CTHULHU использует уникальный алгоритм для получения прибыли в BUSD и других токенах. Кроме того, мы создаем собственную экосистему, в которую войдут функции АММ, P2E, мини-игры и многое другое.</p> }
                            </div>
                        </div>
                        <div className="col-12">
                                    ...
                                    <div className="col-12 col-lg-12 accordian-panel mb-5">
                                        ...
                                        <div className="accordion__card">
                                            ...
                                            <div id="collapse5"  data-parent="#accordion">
                                                <p> CTHULHU generates profit automatically using an arbitration system.</p>
                                            </div>
                                            )}
                                            { global.lan === true && clipId === 5 && (
                                            <div id="collapse5"  data-parent="#accordion">
                                                <p> CTHULHU имеет уникальный алгоритм генерации прибыли, за счёт арбитража криптовалюты.</p>
                                            </div>
                                            )}    
                                        </div>
                                    </div>
